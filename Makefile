prog: main.o Symbol.o SymbolTable.o Opcode.o OpcodeTable.o Validator.o FileHandler.o
	g++ -std=c++11 main.o Symbol.o SymbolTable.o Opcode.o OpcodeTable.o Validator.o FileHandler.o -o prog
